  ...
  return (
    <div className={styles.heroContainer}>
      <section className={styles.hero} aria-label="Hero Showcase">
        {/* Faint traditional Indonesian motif watermark */}
        <div className={styles.hero__motif} aria-hidden="true" />
        
        {/* Faint traditional Batik Floral ornament in the bottom left */}
        <div className={styles.hero__batik} aria-hidden="true" />

        {/* Left Section: Brand typography, divider, CTAs */}
        <div className={styles.hero__left}>
          ...
          {/* Thin Gold Editorial Divider */}
          <div className={styles.hero__divider}>
            <span className={styles['hero__divider-line']} />
            <span className={styles['hero__divider-diamond']} />
            <span className={styles['hero__divider-line']} />
          </div>
        ...
        {/* Right Section: Fabrics Showcase with overlay mask */}
        <div className={styles.hero__right}>
          <div className={styles['hero__image-wrapper']}>
            <img
              ref={bgRef}
              src="/images/hero/hero-main.jpg"
              alt="Premium Indonesian Tenun Ikat Fabrics Stack"
