...
// Ensure image assets exist on disk in development
if (typeof window === 'undefined') {
  try {
    ...
    const writeImg = (subFolder, fileName, sourceFile) => {
    ...
    ['nusa-indah-1.jpg', 'ratna-dress-1.jpg', 'majapahit-blazer-1.jpg', 'candramawa-scarf-1.jpg', 'surya-shirt-1.jpg', 'swarna-kimono-1.jpg', 'signature-piece.jpg'].forEach(n => {
      writeImg('collections', n, 'collection_piece_1785149560519.png');
    });
    [1,2,3,4].forEach(i => writeImg('lookbook', `lookbook-${i}.jpg`, 'brand_intro_1785149543804.png'));
    [1,2,3,4,5,6].forEach(i => writeImg('instagram', `insta-${i}.jpg`, 'collection_piece_1785149560519.png'));
  } catch (e) {
    // Ignore runtime error on client
  }
}
